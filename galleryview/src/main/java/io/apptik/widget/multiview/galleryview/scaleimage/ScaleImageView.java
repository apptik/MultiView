...
public interface ScaleImageView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(ImageViewScaler.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(ImageViewScaler.OnPhotoTapListener listener);

    /**
     * Returns a listener to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @return ImageViewScaler.OnPhotoTapListener currently set, may be null
     */
    ImageViewScaler.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(ImageViewScaler.OnViewTapListener listener);
     ...
     *
     * @return ImageViewScaler.OnViewTapListener currently set, may be null
     */
    ImageViewScaler.OnViewTapListener getOnViewTapListener();
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (ImageViewScaler.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of ScaleImageView (eg. ImageViewScaler), can be used to provide better
     * integration
     *
     * @return ScaleImageView implementation instance if available, null if not
     */
    ScaleImageView getScaleImageViewImplementation();

    /**
     * Sets custom double tap listener, to intercept default given functions. To reset behavior to
     * default, you can just pass in "null" or public field of ImageViewScaler.defaultOnDoubleTapListener
     *
     ...
     */
    void setOnScaleChangeListener(ImageViewScaler.OnScaleChangeListener onScaleChangeListener);
}
