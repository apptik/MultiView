...
public class ItemSelectionSupport {
    ...
    public static ItemSelectionSupport addTo(RecyclerView recyclerView) {
        ...
        if (itemSelectionSupport == null) {
            ...
            recyclerView.setTag(R.id.multiview_item_selection_support, itemSelectionSupport);
        } else {
            // TODO: Log warning
        }
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        ...
        recyclerView.setTag(R.id.multiview_item_selection_support, null);
    }
    ...
    public static ItemSelectionSupport from(RecyclerView recyclerView) {
        ...
        return (ItemSelectionSupport) recyclerView.getTag(R.id.multiview_item_selection_support);
    }
